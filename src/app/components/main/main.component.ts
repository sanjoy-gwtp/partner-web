...
export class MainComponent implements OnInit {
  ...
  constructor(public router: Router, private utilityService: UtilityService,
    private cartService: CartService, public tokenStoreService: TokenStoreService,
  ...
  openLoginModal(e: any) {
    // console.log('openLoginModal');
    e.preventDefault();
    this.utilityService.openLoginModal();
  }

  onNotifyLogout(e: any) {
    // console.log(e);
    if (e) {
      this.tokenStoreService.retrieve();
      this.tokenStoreService.isLogedIn = false;
